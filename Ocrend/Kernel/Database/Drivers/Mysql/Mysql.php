...
class Mysql extends \mysqli implements Driver {
    ...
    public function __construct() {
        ...
        # permitir carga de archivos locales en MySQL
    ...
    */
    ...
    final public function query_select(string $query)  {
        ...
        if(strtoupper(substr($query,0,6)) == "UPDATE" || strtoupper(substr($query,0,8)) == "TRUNCATE" || strtoupper(substr($query,0,4)) == "LOAD" || strtoupper(substr($query,0,6)) == "INSERT" || strtoupper(substr($query,0,6)) == "DELETE") 
            return $result;
