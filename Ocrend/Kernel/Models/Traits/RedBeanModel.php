...
trait RedBeanModel {
     ...
     * @return void
     */
    static function startRedBeanConexion($driver = null) {
        global $config;
        ...
        switch ($driver) {
            case 'mysql':
                R::setup('mysql:host='.$config['database']['drivers']['mysql']['host'].';dbname='.$config['database']['drivers']['mysql']['name'],
    ...
    protected function closeRedBeanConexion() {
        R::close();
    }
